# Non-Disclosure Agreement — Research Participant

> **Note to creator (markl):** This is a template, not a legally reviewed document. Before using it with real participants, have an attorney review it. Requirements vary by jurisdiction.
...
- Stop the session at any time without penalty
- Request that your data be deleted after the session by contacting [contact email]

Withdrawing does not affect your eligibility for compensation.
...
### 7. No Confidential Obligation on Participant

This agreement does not prevent you from discussing the topics covered in the interview with others. We are simply asking that you not share any unpublished product designs or prototypes that may be shown to you during the session (if applicable).

---

### 8. Acknowledgment

By signing below (or by checking the box in the online form), you confirm that:
...
*For questions, contact: [researcher email] or [creator email]*
