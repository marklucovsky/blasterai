...
enum ImageSetCatalog {
    ...
    static let system: [ImageSetDescriptor] = [
        ImageSetDescriptor(
            ...
            displayName: "Classic",
            shortName: "Classic",
            summary: "Flat pictograms — closest to most school boards, printed cards, and other AAC apps.",
            bundlePrefix: "cls",
            version: "1.0.0",
        ...
        ImageSetDescriptor(
            ...
            shortName: "Medium",
            summary: "Classic with a medium skin tone, matching the 🏽 emoji modifier.",
            bundlePrefix: "clsm",
            version: "1.0.0",
        ...
        ImageSetDescriptor(
            ...
            shortName: "Med-Dark",
            summary: "Classic with a medium-dark skin tone, matching the 🏾 emoji modifier.",
            bundlePrefix: "clsmd",
            version: "1.0.0",
        ...
        ImageSetDescriptor(
            ...
            summary: "Soft 3D characters. Warmer and more playful; less like traditional symbol sets.",
            bundlePrefix: "p3d",
            version: "1.0.0",
        ...
        ImageSetDescriptor(
            ...
            shortName: "Contrast",
            summary: "Bold white-on-black. Built for low vision and CVI.",
            bundlePrefix: "hc",
